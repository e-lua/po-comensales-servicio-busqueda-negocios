...
func Pg_Comensal_SearchByName(name string) ([]models.Pg_Found_All_Business, int, error) {
...
func Pg_Comensal_SearchByName_Test(name string) ([]models.Pg_Found_All_Business, int, error) {
